...
public class StudentDao
{
	...
	private final static String insertStudent="insert into Student(name,email,password,mobileno) values(?,?,?,?)";
	private static final String displayAllStudentsQry="select * from student";
	private final static String updateStudent="update student set name=?,email=?,password=?,mobileno=? where sno=?";
	...
	private final static String validateAdmin="select * from admin where name=? and email=? and password=?";
